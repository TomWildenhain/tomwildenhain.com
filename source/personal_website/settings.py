...
SECRET_KEY = 'f3%qd27il-mcn-lf@tazx+7259r(o2w&-u@#i16(m42$lm-b78'
...
TEMPLATES = [
    {
        ...
        'DIRS': [(os.path.join(BASE_DIR, 'personal_website', 'templates')),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'personal_website', 'media')